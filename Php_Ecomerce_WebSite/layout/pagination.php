...
$variable = $_POST['table']; // determine which table in the database
$products_per_page = 5; // Set the number of products per page
// Query to count total number of products
$query_count = "SELECT COUNT(*) AS total FROM `$variable`";
...
$query_page = "SELECT * FROM `$variable` LIMIT $start_index, $products_per_page";
